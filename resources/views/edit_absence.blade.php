        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <form method="POST" action="{{ url('/update_absence','find_absence->id') }}">
		                  {{ csrf_field() }}
                      {{ method_field('PUT') }}
			             <input name="_token" type="hidden" value="{{ csrf_token() }}"/>
                        <input type="hidden" name="id" value= "{{ $find_absence->id }}"/>

                        
                        <label for="date">Data</label>
                       
                        <div class="input-group date">
                        <input type="text" class="form-control" autocomplete="off" id="sandbox-container" name="date" value="{{$find_absence->payment}}"  ><span class="input-group-addon"><i class="glyphicon glyphicon-th"></i></span>
                        </div>
                        <br>
